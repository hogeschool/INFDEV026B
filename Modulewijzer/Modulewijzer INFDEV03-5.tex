...
\newcommand{\modulenaam}{Advanced Databases \\(Development 6B)}
\newcommand{\modulecode}{\uppercase{ INFDEV026B}}
\newcommand{\stdPunten}{4 ects}
\renewcommand{\author}{Ahmad Omar, Francesco Di Giacomo}
...
\shadowsectionbox
\input{tex/Modulebeschrijving}
\newpage
\input{tex/AlgemeneOmschrijving}
\newpage
\input{tex/Programma}
\newpage
\input{tex/Toetsing}
...
\input{tex/Bijlage1}
\newpage
\input{tex/Practicums}
\newpage
\input{tex/ExamStructure}
\newpage
