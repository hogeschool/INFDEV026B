...
\begin{frame}
	...
	\end{figure}
	\begin{itemize}
		\item \textbf{Example}: \tuple{3}{SSN,HOURS,ENAME} in the table below is the combination of values: 
		\pause
		\tuple{3}{SSN,HOURS,ENAME} = \valseq{666884444,40.0,Narayan, Ramesh K.}
	\end{itemize}
\end{frame}
